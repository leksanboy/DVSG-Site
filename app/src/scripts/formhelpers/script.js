...
var BFHCountriesList = {
    ...
    b.prototype = {
        ...
        addCountries: function() {
            var a, b, c;
            a = this.options.country, c = this.getCountries(), this.$element.html(""), this.options.blank === !0 && this.$element.append('<option class="selectedItem" value="">Country</option>');
    ...
    b.prototype = {
        ...
        loadStates: function(a) {
            var b, c;
            b = this.options.state, this.$element.html(""), this.options.blank === !0 && this.$element.append('<option class="selectedItem" value="">City</option>');
