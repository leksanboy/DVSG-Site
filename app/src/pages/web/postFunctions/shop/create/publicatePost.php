<?php require_once('../../../../Connections/conexion.php');
	...
	if (isset($_POST["titulo"])) {
		...
		$insertSQL = sprintf("INSERT INTO z_posts (time, titulo, keywords, contenido, km, power, year, fuel, engine, bodytype, countryVal, country, cityVal, city, prefix, phone, price, currency, autor, tipo) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
