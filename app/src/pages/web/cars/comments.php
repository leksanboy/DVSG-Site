<?php  if (isset($_SESSION['MM_Id'])){?>
    <div class="newComment">
        <form onsubmit="return false">
            ...
            <input type="hidden" name="page" value="<?php echo $iddelmodel; ?>" />
            ...
            <div class="box" id="comentariosPostId<?php echo $row_GetComments['id'] ?>">
                ...
                <?php if (isset ($_SESSION['MM_Id'])){ ?> 
                    <?php  if (($row_GetComments['user'] == $_SESSION['MM_Id']) || (rango_admin ($_SESSION['MM_Id']) ==4)) {?>
                        <div class="delete" onClick="deleteComment('<?php echo $row_GetComments['id'] ?>');">
...
<?php  if (isset($_SESSION['MM_Id'])){?>
    <?php if ($totalRows_GetCommentsCount>4) { ?>
        <div class="showMoreComments" onclick="moreComments('4','<?php echo $iddelmodel; ?>');">
