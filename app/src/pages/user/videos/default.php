<?php require_once('../../../Connections/conexion.php');
	...
	$_SESSION['loadMoreVideos'.$userId] = 0;
		...
		<?php do { ?>
			<li class="video<?php echo $row_videosList['id'] ?>">
				<div class="video" onclick="openVideo(1, '<?php echo $row_videosList['name']?>', '<?php echo $row_videosList['title']?>', '<?php echo $row_videosList['video']?>')">
					<div class="thumb" style="background-image: url(<?php echo $urlWeb ?>pages/user/videos/videos/thumbnails/<?php echo substr($row_videosList['name'], 0, -4)?>.jpg); width: 100%; height: 150px;"></div>
				</div>
				<div class="title">
				...
				<?php  if (isset($_SESSION['MM_Id'])) { ?>
					<div class="actions">
                        <?php if ($userId == $_SESSION['MM_Id']) { ?>
                            <div class="add" onClick="deleteVideo(1, <?php echo $row_videosList['id'] ?>)">
